...
public class ThemeUtil {
    ...
    public static final int THEME_DEFAULT = 19;
    public static final int THEME_NIGHT = 20;
    ...
    public static ArrayList<Theme> getThemeList(){
        ...
        themeArrayList.add(new Theme(19,R.color.colorPrimary, R.color.colorPrimaryDark, R.color.colorAccent));
        themeArrayList.add(new Theme(20,R.color.primaryColorNight, R.color.primaryDarkColorNight, R.color.AccentColorNight));
